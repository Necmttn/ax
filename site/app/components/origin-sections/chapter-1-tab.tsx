export function Chapter1Tab() {
  return (
    <section className="section">
      <h2><kbd>Tab</kbd> was the harness.</h2>
      ...
      <p>
        The model looked smart because the harness around it was good. The
        harness was a human reacting, all day, for free.
      </p>
    </section>
  );
}
