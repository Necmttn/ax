...
bun run classifiers:workflow-candidates -- --limit=20 --examples=50 --out=.ax/experiments/workflow-candidate-report-helper-usefulness-transcript-current.json --json
bun run classifiers:workflow-candidates -- --source-kind=hybrid_window_classifier_projection --limit=20 --examples=50 --out=.ax/experiments/workflow-candidate-report-helper-usefulness-hybrid-current.json --json
