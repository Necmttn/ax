...
export const SCHEMA_TABLES: readonly SchemaTableSpec[] = [
    ...
    { table: "cache_bust_event", stage: "active", note: "Cache-bust ledger (#868): one row per usage row carrying a cache_miss_reason and its ingest-priced cache-creation cost. Queries corroborate against OTLP cost at root-session grain; derived by the cache-bust SQL model, id == turn_token_usage.id." },
