...
published 6 wrapped cards - the dashboard landing serves them now`,
      ...
      },
      {
        ...
        signature: "ax directives mine [--days=N] [--emit-brief] | list [--status=...] | ngrams [--limit=N] | workflows [--days=N] [--emit-brief]",
        flags: [
          { flag: "--emit-brief", desc: "(mine/workflows) write agent brief to .ax/tasks/" },
          { flag: "--days=N", desc: "(mine/workflows) look-back window in days (default 90)" },
...
12 candidates (90 days)  emit brief: ax directives mine --emit-brief`,
        detail: [
          ...
          "ax directives workflows mines recurring skill-arc workflows (ordered sequences of skills length 3–6 across ≥ 3 sessions, gapped + maximal); --emit-brief writes .ax/tasks/workflows-<date>.md for agent review.",
