  ...
  return (
    <section className="section">
      ...
      <aside className="framework-list" aria-label="five requirements the retro loop has to meet">
        ...
        <ul>
          <li><span className="fw-name">01 · capture while context is warm</span><span className="fw-note">the reflection has to land while the agent still has its context loaded. ax does it pull-based - a stale read quietly forks a catch-up ingest, no Stop hook wedged into the turn.</span></li>
