...
const SCENES: Scene[] = [
  {
    ...
    script: [
      ...
      { kind: "cmd", text: "⏺ Bash(axctl retro emit --session=4129)", delay: 620, pulse: "claude" },
      { kind: "ingest", text: "ingesting transcript", delay: 240, pulse: "git" },
      { kind: "out", text: "⎿ tried=8 · worked=6 · failed=3 · next=2", delay: 360 },
      { kind: "cmd", text: "⏺ Bash(axctl retro reflect --since=7d)", delay: 760, pulse: "subagent" },
      ...
      { kind: "cmd", text: "⏺ Bash(axctl improve accept post-feature-verify --with-agent)", delay: 680, pulse: "subagent" },
  ...
  },
  {
    ...
    script: [
      ...
      { kind: "cmd", text: "$ axctl recall --session=0e9c5a1 --top=5", delay: 640, pulse: "codex" },
      { kind: "ingest", text: "ingesting transcript", delay: 240, pulse: "git" },
      ...
      { kind: "cmd", text: "$ axctl skills pairs --since=session=0e9c5a1", delay: 720, pulse: "subagent" },
      ...
      { kind: "cmd", text: "$ axctl workflow synth --from=0e9c5a1 --name=clean-feature-ship", delay: 700, pulse: "subagent" },
