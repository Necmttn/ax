...
- **cost_cache** - cache-bust cost attribution: busts by cause with cache re-establishment cost, top offenders by native attribution, and root-session OTLP cost corroboration (`ax cost cache`).
