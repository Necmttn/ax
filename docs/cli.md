...
- **cost_cache** - cache-bust cost attribution: busts by cause with cache re-establishment cost, top offenders by native attribution, corroborated pricing (`ax cost cache`).
