...
export const IngestStageKey = Schema.Union([SkillsKey, CommandsKey, ClaudeKey, CodexKey, SubagentsKey, SpawnedKey, GitKey, SignalsKey, OutcomesKey, SessionHealthKey, ClosureKey, ProposalsKey, OpportunitiesKey]);
...
export const ALL_STAGES = [skillsStage, commandsStage, claudeStage, codexStage, subagentsStage, spawnedStage, gitStage, signalsStage, outcomesStage, sessionHealthStage, closureStage, proposalsStage, opportunitiesStage] as const;
