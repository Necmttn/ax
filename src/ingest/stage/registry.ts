...
export const IngestStageKey = Schema.Union([SkillsKey, CommandsKey, ClaudeKey, CodexKey, SubagentsKey, InvokedPositionsKey, SpawnedKey, GitKey, SignalsKey, OutcomesKey, SessionHealthKey, ClosureKey, ProposalsKey, OpportunitiesKey, RetroProposalsKey, HarnessKey]);
...
export const ALL_STAGES = [skillsStage, commandsStage, claudeStage, codexStage, subagentsStage, invokedPositionsStage, spawnedStage, gitStage, signalsStage, outcomesStage, sessionHealthStage, closureStage, proposalsStage, opportunitiesStage, retroProposalsStage, harnessStage] as const;
