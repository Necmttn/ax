...
describe("classifier package operations report", () => {
    ...
    test("builds multi-package operation summaries", () => {
        ...
        expect(report.totals.operation_kinds.review).toBe(14);
        expect(report.totals.operation_kinds.status).toBe(17);
        ...
        expect(report.packages.find((entry) => entry.package_key === "session-section-chunks")?.operation_count).toBe(42);
        ...
        expect(report.packages.find((entry) => entry.package_key === "session-section-chunks")?.operation_kinds.review).toBe(14);
        expect(report.packages.find((entry) => entry.package_key === "session-section-chunks")?.operation_kinds.status).toBe(17);
