...
describe("classifier package operations report", () => {
    ...
    test("builds multi-package operation summaries", () => {
        ...
        expect(report.totals.operation_kinds.publish).toBe(3);
        ...
        expect(report.packages.find((entry) => entry.package_key === "session-section-chunks")?.operation_count).toBe(46);
        ...
        expect(report.packages.find((entry) => entry.package_key === "session-section-chunks")?.operation_kinds.publish).toBe(3);
